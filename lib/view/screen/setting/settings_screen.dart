...
import 'package:shopiana/view/screen/setting/widget/currency_dialog.dart';
            ...
            Expanded(
              ...
              children: [
                ...
                TitleButton(
                  ...
                  title:
                      '${getTranslated('currency', context)} (${Provider.of<SplashProvider>(context).configModel!.currency})',
