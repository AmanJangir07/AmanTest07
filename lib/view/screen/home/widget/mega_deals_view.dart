...
//                   String _priceRange;
//                   if (megaProvider.megaDealList[index].choiceOptions.length !=
//                       0) {
//                     List<double> _priceList = [];
//                     megaProvider.megaDealList[index].variation.forEach(
//                         (variation) =>
//                             _priceList.add(double.parse(variation.price)));
//                     _priceList.sort((a, b) => a.compareTo(b));
//                     if (_priceList[0] < _priceList[_priceList.length - 1]) {
//                       _priceRange =
//                           '${PriceConverter.convertPrice(context, _priceList[0])} - ${PriceConverter.convertPrice(context, _priceList[_priceList.length - 1])}';
//                     } else {
//                       _priceRange =
//                           PriceConverter.convertPrice(context, _priceList[0]);
//                     }
//                   } else {
//                     _priceRange = PriceConverter.convertPrice(
//                         context,
//                         double.parse(
...
//                             ),
//                             child: Text(
//                               '${megaProvider.megaDealList[index].discountType == 'percent' ? megaProvider.megaDealList[index].discount : (double.parse(megaProvider.megaDealList[index].discount) / (double.parse(megaProvider.megaDealList[index].unitPrice) * 100)).toStringAsFixed(1)}% OFF',
//                               style: robotoRegular.copyWith(
//                                   color: ColorResources.WHITE,
