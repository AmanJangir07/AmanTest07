...
import 'package:shopiana/view/basewidget/custom_loader.dart';
import 'package:shopiana/view/basewidget/my_dialog.dart';
                      ...
                      if (url == '${AppConstants.BASE_URL}success') {
                        ...
                        showAnimatedDialog(
                            ...
                            MyDialog(
                              ...
                              description:
                                  getTranslated('your_payment_failed', context),
                              isFailed: true,
                            ),
                            dismissible: false,
                            isFlip: true);
