                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return RadioListTile(
                                title: Text(
                                    '${order.shippingList![index].title} (Duration: ${order.shippingList![index].duration}, Cost: ${PriceConverter.convertPrice(context, double.parse(order.shippingList![index].cost!))})'),
                                value: index,
